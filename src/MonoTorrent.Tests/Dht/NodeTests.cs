...
namespace MonoTorrent.Dht
{
    ...
    public class NodeTests
    {
        ...
        public void CompactPort()
        {
            ...
            Assert.Equal(1, port.TextBytes[0], "#1");
            Assert.Equal(21, port.TextBytes[1], "#1");
            Assert.Equal(121, port.TextBytes[2], "#1");
            Assert.Equal(3, port.TextBytes[3], "#1");
            Assert.Equal(1, port.TextBytes[4], "#1");
            Assert.Equal(255, port.TextBytes[5], "#1");
        }
        ...
        public void FromCompactNode()
        {
            ...
            Assert.True(Toolbox.ByteMatch(buffer, 0, n.Id.Bytes, 0, 20), "#1");
            Assert.Equal(IPAddress.Parse("1.21.131.3"), n.EndPoint.Address, "#2");
            Assert.Equal(511, n.EndPoint.Port, "#3");
        }
        ...
        public void CompactNode()
        {
            ...
            Assert.Equal(1, port.TextBytes[20], "#1");
            Assert.Equal(21, port.TextBytes[21], "#1");
            Assert.Equal(121, port.TextBytes[22], "#1");
            Assert.Equal(3, port.TextBytes[23], "#1");
            Assert.Equal(1, port.TextBytes[24], "#1");
            Assert.Equal(255, port.TextBytes[25], "#1");
        }
