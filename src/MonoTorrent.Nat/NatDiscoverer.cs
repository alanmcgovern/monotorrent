...
namespace MonoTorrent.Nat
{
    ...
    public class NatDiscoverer
    {
        ...
        /// used for debugging and <see cref="https://github.com/lontivero/MonoTorrent.Nat/wiki/Troubleshooting">Troubleshooting</see>
        /// </summary>
        /// <example>
        ...
        /// </remarks>
        /// <remarks>
        /// MonoTorrent.Nat only supports SourceLevels.Verbose, SourceLevels.Error, SourceLevels.Warning and SourceLevels.Information.
        /// </remarks>
        public readonly static TraceSource TraceSource = new TraceSource("MonoTorrent.Nat");
        ...
        /// <summary>
        /// Release all ports opened by MonoTorrent.Nat. 
        /// </summary>
        /// <remarks>
